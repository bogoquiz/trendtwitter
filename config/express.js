...
module.exports = function(db) {
	...
	var countryTwitter = require('../app/controllers/customers.server.controller');
	var user;
    ...
    io.on('connection', function(socket) {  
				...
				socket.on('countryenv', function(data) {
					...
					console.log(user);
            		countryTwitter.countryTwitter(data, user, socket);
            		//var test = require('../app/controllers/customers.server.controller').myObj; 
            		//console.log(test);
            		//socket.emit('trendenv',test);

            	});

				socket.on('updatetw', function(data){
    			//params = data;
